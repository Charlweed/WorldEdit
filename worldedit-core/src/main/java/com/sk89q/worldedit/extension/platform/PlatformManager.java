...
public class PlatformManager {
    ...
    /**
     * This is tricky. We would prefer CommandManager to be final, but it is
     * constructed with 'this', and then puts itself on an event queue. Leaking
     ...
     * constructor, to insure that all instances are fully initialized when they
     * are added to that event queue. Always call this immediately after
     * construction!
     */
    private void init() {
     ...
     *
     * <p>
     * If the platform has been chosen for any capabilities, then a new platform
     * will be found.</p>
     *
     * @param platform the platform
     */
     ...
     *
     * <p>
     * The returned list is a copy of the original and is mutable.</p>
     *
    ...
    /**
     * Given an actor, return a new one that may use a different platform for
     * permissions and world editing.
     *
     ...
     *
     * <p>
     * If no platform has been registered yet, then a default configuration will
     * be returned.</p>
     *
